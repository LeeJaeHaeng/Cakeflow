      ...
      sections={[
        {
          title: "수집하는 개인정보",
          body: [
            "필수 항목: 이름, 휴대폰 번호, 주문 상품, 픽업일시, 주문 요청사항, 입금 확인 및 환불 처리 정보",
        ...
        },
        {
          title: "개인정보 이용 목적",
          body: [
            "주문 접수, 본인 확인, 계좌이체 입금 확인, 제작 상담, 픽업 안내, 주문 상태 알림, 환불 및 고객 문의 응대에 이용합니다.",
          ],
        },
        {
          title: "보유 및 이용 기간",
        ...
        },
        {
          title: "제3자 제공 및 처리위탁",
          body: [
            "현재 온라인 PG 결제는 사용하지 않으며, 계좌이체 입금 확인은 매장 운영자가 직접 확인합니다.",
